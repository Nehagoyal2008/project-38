...
eating=loadImage("Living Room.png");
player=loadImage("Garden.png");
sleepDog=loadImage("BedRoom.png");
covid=loadImage("runningLeft.png");
noooo=loadImage("running.png");
lazyDog=loadImage("Lazy.png")
vaccine=loadImage("dogVaccination.png")
